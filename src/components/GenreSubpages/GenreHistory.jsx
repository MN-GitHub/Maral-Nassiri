...
import "../../styles/GenreHistory.css";
import "../../styles/General.css";

function GenreHistory({ data }) {
  const [showAnswer, setShowAnswer] = useState(false);

  return (
    <div className="genre-history-page">
      <h2 className="genre-history-heading">{data.title}</h2>
      <div className="genre-history-container">
        ...
        <div className="photo-box">
          <img src={data.image} alt="Geschichte" className="genre-history-photo" />
        </div>
      </div>
